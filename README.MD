...
# Find the `RegisterNetEvent` `inventory:server:SetInventoryData` (only if you don't use mh-inventory)
- Replace that code with this code below, and make cure you backup the old code.
```lua
